...
- A private read-only Cloudflare route reader with fixed zone and DNS endpoints, bounded paginated responses, one deadline, no redirects or retries, and no credential or raw-ID output. It remains unwired and cannot authorize deployment.
