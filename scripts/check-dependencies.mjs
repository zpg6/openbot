...
function checkD1ProbeCanaryResponseArchiveBoundary(file, content, imports) {
    ...
    if (importsArchive && !new Set([test, responseClaimsSource, responseClaimsTest]).has(file)) {
        errors.push(
...
function checkD1ProbeCanaryResponseClaimsBoundary(file, content, imports) {
    ...
    if (
        ...
        !content.includes('if (state !== "bound" || boundIntent === null || boundStartedDigest === null)') ||
