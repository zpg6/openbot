...
const checkSources = input => {
    ...
    requireAll(
        ...
        [
            ...
            'app.post("/actions/chat-messages"',
            ...
            "dependencies.connector.listCatalogApps?.()",
            ...
            "dependencies.connector.api_version",
            "dependencies.connector.session_serialization_identity",
    ...
    requireAll(
        ...
        [
            ...
            "PermissionLevel",
            "permissionsThroughLevel",
            'className="permission-levels"',
            "Choose exact tools. The organization limit still applies.",
            "page.view.catalog_apps",
