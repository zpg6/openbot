...
import { canonicalD1ProbeGatewayParentAssignmentV1, type D1ProbeGatewayParentAssignmentV1 } from "./parent.js";
    ...
    await new Promise((resolve, reject) => {
        const child = spawn(
            ...
            [
                "--import",
                "tsx",
                fileURLToPath(new URL("./parent-cli.ts", import.meta.url)),
