...
import { compileD1ProbeCloudflareWorkerCanaryCleanupObligationV1 } from "../src/cloudflare-worker-canary-cleanup-obligation.js";
import {
...
} from "../src/cloudflare-worker-canary-dispatch-claims.js";
import type { D1ProbeCloudflareWorkerCanaryDriverLeaseOwnerV1 } from "../src/cloudflare-worker-canary-driver-lease.js";
...
const harnessFor = async (operation: D1ProbeCloudflareWorkerCanaryOperationV1): Promise<HarnessV1> => {
    ...
    const missing: D1ProbeCloudflareWorkerCanaryConsistencyV1 = {
        ...
        driver_lease_record_digest: null,
