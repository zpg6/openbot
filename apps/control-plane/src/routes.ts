...
const actionPaths = [
    ...
    "/actions/organization-compute-policies",
    "/actions/organization-compute-policies/:policyId/disables",
    "/actions/skills",
    ...
    "/actions/compute-grants",
    "/actions/compute-grants/:grantId/revocations",
...
const apiRoutes = [
    ...
    ["GET", "/api/v1/organization-compute-policies"],
    ["POST", "/api/v1/organization-compute-policies"],
    ["GET", "/api/v1/organization-compute-policies/:policyId"],
    ["POST", "/api/v1/organization-compute-policies/:policyId/disables"],
    ["GET", "/api/v1/skills"],
    ["POST", "/api/v1/skills"],
    ...
    ["GET", "/api/v1/compute-grants"],
    ["POST", "/api/v1/compute-grants"],
    ["GET", "/api/v1/compute-grants/:grantId"],
    ["POST", "/api/v1/compute-grants/:grantId/revocations"],
